...
export const STITCH_THEMES: readonly StitchThemeToken[] = [
  {
    id: 'bg-[#141211]',
    slug: 'cozy-loft',
    name: 'Cozy Loft (Amber)',
    color: '#141211',
    customColor: '#f59e0b',
    neutralColor: '#141211',
    colorVariant: 'FIDELITY' as any,
    cssVariables: {
      '--theme-bg': '#141211',
      '--theme-surface': '#1c1917',
      '--theme-surface-elevated': '#262320',
      '--theme-surface-subtle': '#181615',
      '--theme-surface-overlay': 'rgba(20, 18, 17, 0.92)',
      '--theme-border': 'rgba(245, 158, 11, 0.20)',
      '--theme-border-subtle': 'rgba(245, 158, 11, 0.10)',
  ...
  },
  {
    ...
    cssVariables: {
      ...
      '--theme-surface-elevated': '#1e2622',
      '--theme-surface-subtle': '#131715',
      '--theme-surface-overlay': 'rgba(16, 20, 18, 0.92)',
      '--theme-border': 'rgba(132, 169, 140, 0.22)',
      '--theme-border-subtle': 'rgba(132, 169, 140, 0.12)',
      '--theme-primary': '#84a98c',
      '--theme-primary-hover': '#a3c4ab',
      '--theme-text-primary': '#f4f7f5',
      '--theme-text-secondary': '#d5e2d8',
      '--theme-text-muted': '#8e9e93',
      '--theme-focus-ring': 'rgba(132, 169, 140, 0.35)',
    },
  },
  {
    id: 'bg-[#080d2a]',
